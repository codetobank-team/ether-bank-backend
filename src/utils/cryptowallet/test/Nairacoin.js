...
contract('Nairacoin', (accounts) => {
  let tokenInstance;

  it(' ...initializing the contract with the correct default values', () => Nairacoin.deployed()
    .then((instance) => {
  ...
  it(' ...allocating an initial supply upon deployment', () => Nairacoin.deployed()
    .then((instance) => {
      tokenInstance = instance;
  ...
  it(' ...transfer(_to, _value): Tranfers token ownership', () => Nairacoin.deployed()
    .then((instance) => {
      tokenInstance = instance;
  ...
  it(' ...approve(from, to, value): approves tokens for delegated transfer', () => Nairacoin.deployed()
    .then((instance) => {
      tokenInstance = instance;
  ...
  it(' ...transferFrom(from, spender, value): handles delegated token transfers', () => (
    Nairacoin.deployed()
      .then((instance) => {
        tokenInstance = instance;
